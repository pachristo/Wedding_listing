...
--
-- Host: localhost:3306
-- Generation Time: Jul 15, 2022 at 05:22 AM
...
--
-- Table structure for table `couple_subscriptions`
--

CREATE TABLE `couple_subscriptions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `planName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `planDescription` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `couple_subscriptions`
--

INSERT INTO `couple_subscriptions` (`id`, `planName`, `planDescription`, `duration`, `price`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Yearly Subscription', 'Yearly Subscripton for Couples', '1 year', '50', '0', '2022-07-06 18:48:43', '2022-07-06 18:48:43');

-- --------------------------------------------------------

--
-- Table structure for table `couple_sub_intents`
--

CREATE TABLE `couple_sub_intents` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `couple_transactions`
--

CREATE TABLE `couple_transactions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `couple_transactions`
--

INSERT INTO `couple_transactions` (`id`, `user_id`, `sub_id`, `unit`, `amount`, `txn_id`, `sub_count`, `created_at`, `updated_at`) VALUES
(1, '14', '1', NULL, '50', '#F0EZSCJ3GBDVF4ALRSBKM1CW76YN', 0, '2022-07-07 07:15:28', '2022-07-07 07:15:28'),
(2, '14', '1', NULL, '50', '#F0EZSCJ3GBDVF4ALRSBKM1CW76YN', 0, '2022-07-07 13:20:07', '2022-07-07 13:20:07');
...
(61, '2022_07_06_183108_create_couple_subscriptions_table', 46),
(62, '2022_07_06_185329_create_couple_sub_intents_table', 47),
(63, '2022_07_07_043758_create_couple_transactions_table', 48);
...
('267ebf279a5d7e0d82ef4a7e6315db7ded215770bbf58dcc8b8ecf97b61389a3cf13cf53ea76e530', 34, 10, 'ithwedapp', '[]', 0, '2022-07-09 21:27:30', '2022-07-09 21:27:30', '2023-07-09 17:27:30'),
...
('3e18a93b2554f99ef098cbfdee84046fa239978b6b20c1dee69158602d89139686ac0d4d9ea0e86f', 14, 10, 'ithwedapp', '[]', 0, '2022-07-07 05:42:53', '2022-07-07 05:42:53', '2023-07-07 06:42:53'),
...
('84a435f232fbb2e6f88eea480d48114b80f68a21b709dcd27f5ce75122a0b3fb24f2dbd861713602', 17, 10, 'ithwedapp', '[]', 0, '2022-07-07 13:18:16', '2022-07-07 13:18:16', '2023-07-07 09:18:16'),
...
('c7c27114f98daf315b57294cff5a4884b4917e677cd8128fc1955e14f175d833121a19b25ee452a6', 38, 10, 'ithwedapp', '[]', 0, '2022-07-11 20:17:08', '2022-07-11 20:17:08', '2023-07-11 16:17:08'),
...
CREATE TABLE `used_templates` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `plan_id` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sub_status` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `subscribed_date` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `next_due_date` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `used_templates` (`id`, `user_id`, `template`, `created_at`, `updated_at`, `plan_id`, `sub_status`, `subscribed_date`, `next_due_date`) VALUES
(1, '17', '3', '2022-06-21 14:21:05', '2022-07-10 00:20:10', '1', '1', '2022-06-21 15:21:05', '2022-07-21 15:21:05');
...
(4, '17', 'our weddding', '|', '2022-07-10 00:19:27', '2022-07-10 00:19:27');
...
(2, '17', 'istockphoto_1300471625_170667ajpg9t6irCNLpOVYLdZKM7nWDit1EXS9KTKV9TZ9p5N7.jpg', 'Peter Oyi', 'Esther Abam', 'Wedding', '12-09-2022', '10:00am', 'Ibom Hall , Uyo', '#fffff', '2022-06-20 13:42:21', '2022-07-10 00:05:01');
...
(6, '17', 'How we met?', 'In the School.', '2022-07-10 00:19:46', '2022-07-10 00:19:46');
...
(4, '17', 'our wedding', '|type:image,name:uwiNkmIhi0nFXTd17mygFVZRcws6w6z2EtzAPsKH8ssSZ7fFC.jpeg|type:image,name:Nr1CeeGlFcP0rOz1qiMfsjkPcvA9oJ6suQAQ2MLUu0O8PZW79.jpeg|type:image,name:pZCS1SPCaLzwF40SUmclJnSeX9QK8QpGydcQyrwoMkGxc1Kx2.jpeg|type:video,name:lirKPsCvKKYMvqg9BmbLYgwBDbcPlitBBmANqb93qcpcy8X5l.mp4|', '2022-06-21 08:51:09', '2022-07-10 00:20:20', 'our weddding'),
(5, '17', 'our wedding', '|type:image,name:uwiNkmIhi0nFXTd17mygFVZRcws6w6z2EtzAPsKH8ssSZ7fFC.jpeg|type:image,name:Nr1CeeGlFcP0rOz1qiMfsjkPcvA9oJ6suQAQ2MLUu0O8PZW79.jpeg|type:image,name:pZCS1SPCaLzwF40SUmclJnSeX9QK8QpGydcQyrwoMkGxc1Kx2.jpeg|type:video,name:lirKPsCvKKYMvqg9BmbLYgwBDbcPlitBBmANqb93qcpcy8X5l.mp4|', '2022-07-10 00:05:18', '2022-07-10 00:20:20', 'our weddding'),
(6, '17', 'our wedding', '|', '2022-07-10 00:24:28', '2022-07-10 00:24:28', 'our weddding'),
(7, '17', 'our wedding', '|', '2022-07-10 00:26:20', '2022-07-10 00:26:20', 'our weddding');
...
--
-- Indexes for table `couple_subscriptions`
--
ALTER TABLE `couple_subscriptions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `couple_sub_intents`
--
ALTER TABLE `couple_sub_intents`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `couple_transactions`
--
ALTER TABLE `couple_transactions`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `couple_subscriptions`
--
ALTER TABLE `couple_subscriptions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `couple_sub_intents`
--
ALTER TABLE `couple_sub_intents`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `couple_transactions`
--
ALTER TABLE `couple_transactions`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
