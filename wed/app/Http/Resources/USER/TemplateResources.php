...
class TemplateResources extends JsonResource
{
    ...
    public function toArray($request)
    {
            ...
            return [
                'id'=> $this->id,
                'name' => $this->name,
                'home' => trim($this->home)==''?'':url('/admin/admin/storage/app/website/images/').'/'.$this->home,
                'gallery' =>  trim($this->gallery)==''?'':url('admin/admin/storage/app/website/images/').'/'.$this->gallery,
                'story' =>  trim($this->story)==''?'':url('admin/admin/storage/app/website/images/').'/'.$this->story,
                'questions' =>  trim($this->questions)==''?'':url('admin/admin/storage/app/website/images/').'/'.$this->questions,
